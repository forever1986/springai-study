...
public class OpenAiAudioApi {
    ...
    public ResponseEntity<byte[]> createSpeech(SpeechRequest requestBody) {
        return this.restClient.post().uri("/v4/chat/completions").body(requestBody).retrieve().toEntity(byte[].class);
    }
    ...
    public record SpeechRequest(
            ...
            @JsonProperty("messages") List<ZhipuSpeechMessage> messages,
        ...
        public  static class ZhipuSpeechMessage{
            public String role;
            public List<ZhipuContent> content;
        }

        public static class ZhipuContent{
            public String type;
            public String text;
            public ZhipuInputAudio input_audio;
        }

        public static class ZhipuInputAudio{
            public String data;
        ...
        public static class Builder {
            ...
            List<ZhipuSpeechMessage> messages;
            ...
            public Builder zhipuSpeechMessage(List<ZhipuSpeechMessage> messages) {
            ...
            public SpeechRequest build() {
                ...
                return new SpeechRequest(this.model, this.input, this.voice, this.messages, this.responseFormat, this.speed);
            }
