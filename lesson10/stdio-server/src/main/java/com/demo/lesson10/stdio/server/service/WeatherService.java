package com.demo.lesson10.stdio.server.service;
...
public class WeatherService {
    ...
    public String getWeatherForecastByCity(String city) {
        // 获取城市的adcode
        String result = restTemplate.getForObject("https://restapi.amap.com/v3/geocode/geo?address=西安&key=02d0ca81fb9ce3e20d4268745f671394", String.class);
